...
*                    interface                                       *
*                                                                    *
*  Copyright (c) 2005 - 2007 Jungo Ltd.  http://www.jungo.com        *
**********************************************************************/
...
#define WDC_ReadMem16(addr, off) dtoh16(*(volatile WORD *)((UPTR)(addr) + (UPTR)(off)))
#define WDC_ReadMem32(addr, off) dtoh32(*(volatile UINT32 *)((UPTR)(addr) + (UPTR)(off)))
#define WDC_ReadMem64(addr, off) dtoh64(*(volatile UINT64 *)((UPTR)(addr) + (UPTR)(off)))

#define WDC_WriteMem8(addr, off, val) *(volatile BYTE * )(((UPTR)(addr) + (UPTR)(off))) = (val)
#define WDC_WriteMem16(addr, off, val) *(volatile WORD * )(((UPTR)(addr) + (UPTR)(off))) = dtoh16(val)
#define WDC_WriteMem32(addr, off, val) *(volatile UINT32 *)(((UPTR)(addr) + (UPTR)(off))) = dtoh32(val)
#define WDC_WriteMem64(addr, off, val) *(volatile UINT64 *)(((UPTR)(addr) + (UPTR)(off))) = dtoh64(val)
