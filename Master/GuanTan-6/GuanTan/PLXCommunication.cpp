...
BOOL CPLXCommunication::PutsReadDrawData(P9054_HANDLE hDev, CPicData *pData)
{
	...
	DWORD dwAddr = MONITOR_WAVE_DATA_ADDRESS; //0x00800

	// DMA方式读取
//	P9054_DMAReadWriteBlock(hDev, MONITOR_WAVE_DATA_ADDRESS, pData, MONITOR_SIZE * 2, TRUE, P9054_MODE_WORD, P9054_DMA_CHANNEL_0);
