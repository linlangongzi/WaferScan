...
void BurstDelay::UiInit()
{
	QIcon icon;
	icon.addFile(QString::fromUtf8("./Resources/gangbancanshushezhi_select.png"), QSize(), QIcon::Normal, QIcon::Off);
	this->setWindowIcon(icon);
	this->setWindowTitle(tr("延迟设置"));
	QRegExp RegF0_200("^(200[.]00|1[0-9]{0,2}[.][0-9]{0,2}|[2-9][0-9][.][0-9]{0,2}|0[.][0-9]{0,2})$");	//延迟 0.00到200.00的正则表达式
	ui.lineEditAll->setValidator(new QRegExpValidator(RegF0_200,ui.lineEditAll));
	ui.lineEditAny->setValidator(new QRegExpValidator(RegF0_200,ui.lineEditAny));
	ui.lineEditProbe1->setValidator(new QRegExpValidator(RegF0_200,ui.lineEditProbe1));
	ui.lineEditProbe2->setValidator(new QRegExpValidator(RegF0_200,ui.lineEditProbe2));
	ui.lineEditProbe3->setValidator(new QRegExpValidator(RegF0_200,ui.lineEditProbe3));
	ui.lineEditProbe4->setValidator(new QRegExpValidator(RegF0_200,ui.lineEditProbe4));
	ui.lineEditProbe5->setValidator(new QRegExpValidator(RegF0_200,ui.lineEditProbe5));
	ui.lineEditProbe6->setValidator(new QRegExpValidator(RegF0_200,ui.lineEditProbe6));
	ui.lineEditProbe7->setValidator(new QRegExpValidator(RegF0_200,ui.lineEditProbe7));
	ui.lineEditProbe8->setValidator(new QRegExpValidator(RegF0_200,ui.lineEditProbe8));
	ui.lineEditProbe9->setValidator(new QRegExpValidator(RegF0_200,ui.lineEditProbe9));
	ui.lineEditProbe10->setValidator(new QRegExpValidator(RegF0_200,ui.lineEditProbe10));
	ui.lineEditProbe11->setValidator(new QRegExpValidator(RegF0_200,ui.lineEditProbe11));
	ui.lineEditProbe12->setValidator(new QRegExpValidator(RegF0_200,ui.lineEditProbe12));
	ui.lineEditProbe13->setValidator(new QRegExpValidator(RegF0_200,ui.lineEditProbe13));
	ui.lineEditProbe14->setValidator(new QRegExpValidator(RegF0_200,ui.lineEditProbe14));
	ui.lineEditProbe15->setValidator(new QRegExpValidator(RegF0_200,ui.lineEditProbe15));
	ui.lineEditProbe16->setValidator(new QRegExpValidator(RegF0_200,ui.lineEditProbe16));
	ui.lineEditProbe17->setValidator(new QRegExpValidator(RegF0_200,ui.lineEditProbe17));
	ui.lineEditProbe18->setValidator(new QRegExpValidator(RegF0_200,ui.lineEditProbe18));
	ui.lineEditProbe19->setValidator(new QRegExpValidator(RegF0_200,ui.lineEditProbe19));
	ui.lineEditProbe20->setValidator(new QRegExpValidator(RegF0_200,ui.lineEditProbe20));
	ui.lineEditProbe21->setValidator(new QRegExpValidator(RegF0_200,ui.lineEditProbe21));
	ui.lineEditProbe22->setValidator(new QRegExpValidator(RegF0_200,ui.lineEditProbe22));
	ui.lineEditProbe23->setValidator(new QRegExpValidator(RegF0_200,ui.lineEditProbe23));
	ui.lineEditProbe24->setValidator(new QRegExpValidator(RegF0_200,ui.lineEditProbe24));
	ui.lineEditProbe25->setValidator(new QRegExpValidator(RegF0_200,ui.lineEditProbe25));
	ui.lineEditProbe26->setValidator(new QRegExpValidator(RegF0_200,ui.lineEditProbe26));
	ui.lineEditProbe27->setValidator(new QRegExpValidator(RegF0_200,ui.lineEditProbe27));
	ui.lineEditProbe28->setValidator(new QRegExpValidator(RegF0_200,ui.lineEditProbe28));
	ui.lineEditProbe29->setValidator(new QRegExpValidator(RegF0_200,ui.lineEditProbe29));
	ui.lineEditProbe30->setValidator(new QRegExpValidator(RegF0_200,ui.lineEditProbe30));
	ui.lineEditProbe31->setValidator(new QRegExpValidator(RegF0_200,ui.lineEditProbe30));
	ui.lineEditProbe32->setValidator(new QRegExpValidator(RegF0_200,ui.lineEditProbe30));
	ui.lineEditProbe33->setValidator(new QRegExpValidator(RegF0_200,ui.lineEditProbe30));
	ui.lineEditProbe34->setValidator(new QRegExpValidator(RegF0_200,ui.lineEditProbe30));
	ui.lineEditProbe35->setValidator(new QRegExpValidator(RegF0_200,ui.lineEditProbe30));
	ui.lineEditProbe36->setValidator(new QRegExpValidator(RegF0_200,ui.lineEditProbe30));
}

void BurstDelay::SelectAll()
{
