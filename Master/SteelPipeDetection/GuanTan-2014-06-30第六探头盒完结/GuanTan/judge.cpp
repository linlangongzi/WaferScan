...
void Judge::AllI()
{
	...
	ui.comboBoxIProbe11->setCurrentIndex(ui.comboBoxAllI->currentIndex());
	ui.comboBoxIProbe12->setCurrentIndex(ui.comboBoxAllI->currentIndex());
}
void Judge::AllA()
{
	...
	ui.comboBoxAProbe11->setCurrentIndex(ui.comboBoxAllA->currentIndex());
	ui.comboBoxAProbe12->setCurrentIndex(ui.comboBoxAllA->currentIndex());
}
void Judge::AllB()
{
	...
	ui.comboBoxBProbe11->setCurrentIndex(ui.comboBoxAllB->currentIndex());
	ui.comboBoxBProbe12->setCurrentIndex(ui.comboBoxAllB->currentIndex());
}
void Judge::AllI2()
{
	...
	ui.comboBoxI2Probe11->setCurrentIndex(ui.comboBoxAllI2->currentIndex());
	ui.comboBoxI2Probe12->setCurrentIndex(ui.comboBoxAllI2->currentIndex());
}
void Judge::AnyI()
{
	if (ui.checkBoxProbe1_10->isChecked())
	{
		...
		if (ui.checkBoxProbe11->isChecked())
			ui.comboBoxIProbe11->setCurrentIndex(ui.comboBoxAnyI->currentIndex());
		if (ui.checkBoxProbe12->isChecked())
			ui.comboBoxIProbe12->setCurrentIndex(ui.comboBoxAnyI->currentIndex());
	}
	else if (ui.checkBoxProbe11_20->isChecked())
	{
...
void Judge::AnyA()
{
	if (ui.checkBoxProbe1_10->isChecked())
	{
		...
		if (ui.checkBoxProbe11->isChecked())
			ui.comboBoxAProbe11->setCurrentIndex(ui.comboBoxAnyA->currentIndex());
		if (ui.checkBoxProbe12->isChecked())
			ui.comboBoxAProbe12->setCurrentIndex(ui.comboBoxAnyA->currentIndex());
	}
	else if (ui.checkBoxProbe11_20->isChecked())
	{
		if (ui.checkBoxProbe13->isChecked())
...
void Judge::AnyB()
{
	if (ui.checkBoxProbe1_10->isChecked())
	{
		...
		if (ui.checkBoxProbe11->isChecked())
			ui.comboBoxBProbe11->setCurrentIndex(ui.comboBoxAnyB->currentIndex());
		if (ui.checkBoxProbe12->isChecked())
			ui.comboBoxBProbe12->setCurrentIndex(ui.comboBoxAnyB->currentIndex());
	}
	else if (ui.checkBoxProbe11_20->isChecked())
	{
		if (ui.checkBoxProbe13->isChecked())
...
void Judge::AnyI2()
{
	if (ui.checkBoxProbe1_10->isChecked())
	{
		...
		if (ui.checkBoxProbe11->isChecked())
			ui.comboBoxI2Probe11->setCurrentIndex(ui.comboBoxAnyI2->currentIndex());
		if (ui.checkBoxProbe12->isChecked())
			ui.comboBoxI2Probe12->setCurrentIndex(ui.comboBoxAnyI2->currentIndex());
	}
	else if (ui.checkBoxProbe11_20->isChecked())
	{
		if (ui.checkBoxProbe13->isChecked())
