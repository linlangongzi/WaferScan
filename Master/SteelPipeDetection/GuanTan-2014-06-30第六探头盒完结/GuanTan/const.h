...
const int BADCOUPLE_RANK = 70; //耦合不良判别标准
...
const float PROBEBOX_DISTANCE1 = 220;//探头盒2与零点差值
const float PROBEBOX_DISTANCE2 = 440;//3
const float PROBEBOX_DISTANCE3 = 660;//4
const float PROBEBOX_DISTANCE4 = 880;//5
const float PROBEBOX_DISTANCE5 = 1100;//6
const float PROBEBOX_DISTANCE6 = 0;//1
const float X_TO_LENGTH = 44.337f;	//X值转化为钢管实际位置，转变参数  wangwei modify on 2014-05-05 编码器刚刚安好时是 45.2355
...
const int PRINT_FEATURE_PRE = 112;
const int PRINT_FEATURE_CUR = 113;
const int PRINT_FEATURE_AFT = 111;
