...
CGain::CGain(QWidget *parent, Qt::WFlags flags)
...
void CGain::UiInit()
{
	...
	this->setWindowTitle(tr("参考增益设置"));
	QRegExp RegN0_60("^(60[.]00|[1-5][0-9]{0,1}[.][0-9]{0,2}|[6-9][.][0-9]{0,2}|0[.][0-9]{0,2})$");	//超声参数-参考增益: 0.00到60.00 的正则表达式
	ui.lineEditAll->setValidator(new QRegExpValidator(RegN0_60,this));
	ui.lineEditAny->setValidator(new QRegExpValidator(RegN0_60,this));
	ui.lineEditProbe1->setValidator(new QRegExpValidator(RegN0_60,this));
	ui.lineEditProbe2->setValidator(new QRegExpValidator(RegN0_60,this));
	ui.lineEditProbe3->setValidator(new QRegExpValidator(RegN0_60,this));
	ui.lineEditProbe4->setValidator(new QRegExpValidator(RegN0_60,this));
	ui.lineEditProbe5->setValidator(new QRegExpValidator(RegN0_60,this));
	ui.lineEditProbe6->setValidator(new QRegExpValidator(RegN0_60,this));
	ui.lineEditProbe7->setValidator(new QRegExpValidator(RegN0_60,this));
	ui.lineEditProbe8->setValidator(new QRegExpValidator(RegN0_60,this));
	ui.lineEditProbe9->setValidator(new QRegExpValidator(RegN0_60,this));
	ui.lineEditProbe10->setValidator(new QRegExpValidator(RegN0_60,this));
	ui.lineEditProbe11->setValidator(new QRegExpValidator(RegN0_60,this));
	ui.lineEditProbe12->setValidator(new QRegExpValidator(RegN0_60,this));
	ui.lineEditProbe13->setValidator(new QRegExpValidator(RegN0_60,this));
	ui.lineEditProbe14->setValidator(new QRegExpValidator(RegN0_60,this));
	ui.lineEditProbe15->setValidator(new QRegExpValidator(RegN0_60,this));
	ui.lineEditProbe16->setValidator(new QRegExpValidator(RegN0_60,this));
	ui.lineEditProbe17->setValidator(new QRegExpValidator(RegN0_60,this));
	ui.lineEditProbe18->setValidator(new QRegExpValidator(RegN0_60,this));
	ui.lineEditProbe19->setValidator(new QRegExpValidator(RegN0_60,this));
	ui.lineEditProbe20->setValidator(new QRegExpValidator(RegN0_60,this));
	ui.lineEditProbe21->setValidator(new QRegExpValidator(RegN0_60,this));
	ui.lineEditProbe22->setValidator(new QRegExpValidator(RegN0_60,this));
	ui.lineEditProbe23->setValidator(new QRegExpValidator(RegN0_60,this));
	ui.lineEditProbe24->setValidator(new QRegExpValidator(RegN0_60,this));
	ui.lineEditProbe25->setValidator(new QRegExpValidator(RegN0_60,this));
	ui.lineEditProbe26->setValidator(new QRegExpValidator(RegN0_60,this));
	ui.lineEditProbe27->setValidator(new QRegExpValidator(RegN0_60,this));
	ui.lineEditProbe28->setValidator(new QRegExpValidator(RegN0_60,this));
	ui.lineEditProbe29->setValidator(new QRegExpValidator(RegN0_60,this));
	ui.lineEditProbe30->setValidator(new QRegExpValidator(RegN0_60,this));
	ui.lineEditProbe31->setValidator(new QRegExpValidator(RegN0_60,this));
	ui.lineEditProbe32->setValidator(new QRegExpValidator(RegN0_60,this));
	ui.lineEditProbe33->setValidator(new QRegExpValidator(RegN0_60,this));
	ui.lineEditProbe34->setValidator(new QRegExpValidator(RegN0_60,this));
	ui.lineEditProbe35->setValidator(new QRegExpValidator(RegN0_60,this));
	ui.lineEditProbe36->setValidator(new QRegExpValidator(RegN0_60,this));
}

void CGain::SelectAll()
{
