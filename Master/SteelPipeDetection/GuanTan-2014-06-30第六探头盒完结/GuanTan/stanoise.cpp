...
void StaNoise::AllI()
{
	...
	if (strAllI != NULL)
	{
		...
		ui.lineEditIProbe11->setText(QString(strAllI));
		ui.lineEditIProbe12->setText(QString(strAllI));
	}
}
void StaNoise::AllA()
{
	...
	if (strAllA != NULL)
	{
		...
		ui.lineEditAProbe11->setText(QString(strAllA));
		ui.lineEditAProbe12->setText(QString(strAllA));
	}
}
void StaNoise::AllB()
{
	...
	if (strAllB != NULL)
	{
		...
		ui.lineEditBProbe11->setText(QString(strAllB));
		ui.lineEditBProbe12->setText(QString(strAllB));
	}
}
void StaNoise::AllI2()
{
	...
	if (strAllI2 != NULL)
	{
		...
		ui.lineEditI2Probe11->setText(QString(strAllI2));
		ui.lineEditI2Probe12->setText(QString(strAllI2));
	}
}
void StaNoise::AnyI()
{
	if (ui.lineEditAnyI->text() != NULL)
	{
		if (ui.checkBoxProbe1_10->isChecked())
		{
			...
			if (ui.checkBoxProbe11->isChecked())
				ui.lineEditIProbe11->setText(QString(ui.lineEditAnyI->text()));
			if (ui.checkBoxProbe12->isChecked())
				ui.lineEditIProbe12->setText(QString(ui.lineEditAnyI->text()));
		}
		else if (ui.checkBoxProbe11_20->isChecked())
		{
...
void StaNoise::AnyA()
{
	if (ui.lineEditAnyA->text() != NULL)
	{
		if (ui.checkBoxProbe1_10->isChecked())
		{
			...
			if (ui.checkBoxProbe11->isChecked())
				ui.lineEditAProbe11->setText(QString(ui.lineEditAnyA->text()));
			if (ui.checkBoxProbe12->isChecked())
				ui.lineEditAProbe12->setText(QString(ui.lineEditAnyA->text()));
		}
		else if (ui.checkBoxProbe11_20->isChecked())
		{
			if (ui.checkBoxProbe13->isChecked())
...
void StaNoise::AnyB()
{
	if (ui.lineEditAnyB->text() != NULL)
	{
		if (ui.checkBoxProbe1_10->isChecked())
		{
			...
			if (ui.checkBoxProbe11->isChecked())
				ui.lineEditBProbe11->setText(QString(ui.lineEditAnyB->text()));
			if (ui.checkBoxProbe12->isChecked())
				ui.lineEditBProbe12->setText(QString(ui.lineEditAnyB->text()));
		}
		else if (ui.checkBoxProbe11_20->isChecked())
		{
			if (ui.checkBoxProbe13->isChecked())
...
void StaNoise::AnyI2()
{
	if (ui.lineEditAnyI2->text() != NULL)
	{
		if (ui.checkBoxProbe1_10->isChecked())
		{
			...
			if (ui.checkBoxProbe11->isChecked())
				ui.lineEditI2Probe11->setText(QString(ui.lineEditAnyI2->text()));
			if (ui.checkBoxProbe12->isChecked())
				ui.lineEditI2Probe12->setText(QString(ui.lineEditAnyI2->text()));
		}
		else if (ui.checkBoxProbe11_20->isChecked())
		{	
			if (ui.checkBoxProbe13->isChecked())
