...
const float PROBEBOX_DISTANCE2 = 220;
const float PROBEBOX_DISTANCE3 = 440;
const float PROBEBOX_DISTANCE4 = 660;
const float PROBEBOX_DISTANCE5 = 880;
const float X_TO_LENGTH = 44.234f;	//X值转化为钢管实际位置，转变参数  wangwei modify on 2014-05-05 编码器刚刚安好时是 45.2355
