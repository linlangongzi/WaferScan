...
void GateSet::GateSetAllI()
{
	if (ui.lineEditAllIB->text() != NULL)
	{
		...
		ui.lineEditProbe0IB->setText(QString(ui.lineEditAllIB->text()));
	}
	if (ui.lineEditAllIL->text() != NULL)
	{
		...
		ui.lineEditProbe0IL->setText(QString(ui.lineEditAllIL->text()));
	}
	if (ui.lineEditAllIT->text() != NULL)
	{
		...
		ui.lineEditProbe0IT->setText(QString(ui.lineEditAllIT->text()));
	}
}
void GateSet::GateSetAllA()
{
	if (ui.lineEditAllAB->text() != NULL)
	{
		...
		ui.lineEditProbe0AB->setText(QString(ui.lineEditAllAB->text()));
	}
	if (ui.lineEditAllAL->text() != NULL)
	{
		...
		ui.lineEditProbe0AL->setText(QString(ui.lineEditAllAL->text()));
	}
	if (ui.lineEditAllAT->text() != NULL)
	{
		...
		ui.lineEditProbe0AT->setText(QString(ui.lineEditAllAT->text()));
	}
}
void GateSet::GateSetAllB()
{
	if (ui.lineEditAllBB->text() != NULL)
	{
		...
		ui.lineEditProbe0BB->setText(QString(ui.lineEditAllBB->text()));
	}
	if (ui.lineEditAllBL->text() != NULL)
	{
		...
		ui.lineEditProbe0BL->setText(QString(ui.lineEditAllBL->text()));
	}
	if (ui.lineEditAllBT->text() != NULL)
	{
		...
		ui.lineEditProbe0BT->setText(QString(ui.lineEditAllBT->text()));
	}
}
void GateSet::GateSetAllI2()
{
	if (ui.lineEditAllI2B->text() != NULL)
	{
		...
		ui.lineEditProbe0I2B->setText(QString(ui.lineEditAllI2B->text()));
	}
	if (ui.lineEditAllI2L->text() != NULL)
	{
		...
		ui.lineEditProbe0I2L->setText(QString(ui.lineEditAllI2L->text()));
	}
	if (ui.lineEditAllI2T->text() != NULL)
	{
		...
		ui.lineEditProbe0I2T->setText(QString(ui.lineEditAllI2T->text()));
	}
}
void GateSet::GateSetAnyI()
{
	if (ui.checkBoxProbe1_10->isChecked())
	{
		...
		if (ui.checkBoxProbe10->isChecked())
		{
			if (ui.lineEditAnyIB->text() != NULL)
			{
				ui.lineEditProbe0IB->setText(QString(ui.lineEditAnyIB->text()));
			}
			if (ui.lineEditAnyIL->text() != NULL)
			{
				ui.lineEditProbe0IL->setText(QString(ui.lineEditAnyIL->text()));
			}
			if (ui.lineEditAnyIT->text() != NULL)
			{
				ui.lineEditProbe0IT->setText(QString(ui.lineEditAnyIT->text()));
			}
		}
	}
	else if (ui.checkBoxProbe11_20->isChecked())
...
void GateSet::GateSetAnyA()
{
	if (ui.checkBoxProbe1_10->isChecked())
	{
		...
		if (ui.checkBoxProbe10->isChecked())
		{
			if (ui.lineEditAnyAB->text() != NULL)
			{
				ui.lineEditProbe0AB->setText(QString(ui.lineEditAnyAB->text()));
			}
			if (ui.lineEditAnyAL->text() != NULL)
			{
				ui.lineEditProbe0AL->setText(QString(ui.lineEditAnyAL->text()));
			}
			if (ui.lineEditAnyAT->text() != NULL)
			{
				ui.lineEditProbe0AT->setText(QString(ui.lineEditAnyAT->text()));
			}
		}
	}
	else if (ui.checkBoxProbe11_20->isChecked())
...
void GateSet::GateSetAnyB()
{
	if (ui.checkBoxProbe1_10->isChecked())
	{
		...
		if (ui.checkBoxProbe10->isChecked())
		{
			if (ui.lineEditAnyBB->text() != NULL)
			{
				ui.lineEditProbe0BB->setText(QString(ui.lineEditAnyBB->text()));
			}
			if (ui.lineEditAnyBL->text() != NULL)
			{
				ui.lineEditProbe0BL->setText(QString(ui.lineEditAnyBL->text()));
			}
			if (ui.lineEditAnyBT->text() != NULL)
			{
				ui.lineEditProbe0BT->setText(QString(ui.lineEditAnyBT->text()));
			}
		}
	}
	else if (ui.checkBoxProbe11_20->isChecked())
...
void GateSet::GateSetAnyI2()
{
	if (ui.checkBoxProbe1_10->isChecked())
	{
		...
		if (ui.checkBoxProbe10->isChecked())
		{
			if (ui.lineEditAnyI2B->text() != NULL)
			{
				ui.lineEditProbe0I2B->setText(QString(ui.lineEditAnyI2B->text()));
			}
			if (ui.lineEditAnyI2L->text() != NULL)
			{
				ui.lineEditProbe0I2L->setText(QString(ui.lineEditAnyI2L->text()));
			}
			if (ui.lineEditAnyI2T->text() != NULL)
			{
				ui.lineEditProbe0I2T->setText(QString(ui.lineEditAnyI2T->text()));
			}
		}
	}
	else if (ui.checkBoxProbe11_20->isChecked())
