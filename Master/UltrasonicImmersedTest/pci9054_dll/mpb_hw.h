...
//	WORD CH_TGC_DA_START;	
	...
	WORD CH_NO;					//参考通道号
//	DWORD id;					// t_Channel.id
	// songchenguang add start on 2011-08-09
	...
	WORD wDelay;				//通道延迟时间
	// songchenguang add end on 2011-08-09
...
#define SETONE_DATA_ADDR_END  0x16072
...
// Song Chenguang add start on 2011-08-16
#define DSP_2_PCI_DATA_ADRESS1		0x12000
#define DSP_2_PCI_DATA_ADRESS2		0x14000
// Song Chenguang add end on 2011-08-16


#define MAX_CHANNEL_NO               4
#define VSOUND                       6000            // m/s

#define ADFREQUENCY                  400      //吴越调试改为100  yachang.huang modify on 2014-04-16       
...
#define MPB_CODER_EN_ADDRESS				0xb8
// 版本信息
