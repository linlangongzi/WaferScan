...
// 		}
	...
	strOffsetCoordinate.Format(_T("(%.2f,%.2f)"),m_pCScanView->m_Offset_Coordinate.x,m_pCScanView->m_Offset_Coordinate.y);
	...
	{
		float fZhanJilv = ccMianji * 100 / pCScanView->m_SelArea;
		CString strZhanJiLv;
...
//	pv.ExSetTxt(_T("D10:J10"),strSCANDate);
	...
	float fMaxLength=0.0;
	int maxRow=41;
	//machao delete start on 2013-07-31
	/*	char cell[11][2]={{'A','A'},{'B','B'},{'C','D'},{'E','E'},{'F','F'},{'G','G'},{'H','H'},{'I','I'},{'J','K'},{'L','M'},{'N','O'}};
	int nCount = m_lstSurfaceResult.GetItemCount();
	for(int i=0; i<nCount; i++)
	{
	...
	pv.ExSetTxt(_T("O15"),strLength);
	*/	
	//machao delete end on 2013-07-31
