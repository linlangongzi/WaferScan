...
const float PROBEBOX_DISTANCE1 = 5;//探头盒1与零点差值
const float PROBEBOX_DISTANCE2 = 10;
const float PROBEBOX_DISTANCE3 = 15;
const float PROBEBOX_DISTANCE4 = 20;
const float PROBEBOX_DISTANCE5 = 25;
const float X_TO_LENGTH = 10000.0f * 16 / 176;   //X值转化为钢管实际位置，转变参数
const float PIPE_LENGTH = 1000;  //钢管长度1米
