...
//#pragma pack(1)
//yachang.huang modify on 2013-11-20
...
typedef struct _ARS200FPGA_CH_CON_REG
{
	...
	WORD wMaiKuan;		//脉宽
	WORD wOPA3692;      //OPA3692模拟开关
    WORD wLMH6720_SDEnable;//LMH6720_SD使能
	WORD wGuanlianEnable; //关联检测使能
	WORD wEnable;		//滤波器使能
    WORD wRet;          //滤波器复位
	WORD wControl;      //滤波器8选1控制
...
typedef struct _CSCAN_ARS200FPGA_CODE_REG
{
	WORD wEnable;		//编码器使能
	WORD wReset;		//编码器复位
	WORD wXLow16;			//X轴编码器低16位
	WORD wXHigh16;		//X轴编码器高16位
	WORD wYLow16;			//Y轴编码器低16位
	WORD wYHigh16;		//Y轴编码器高16位
	WORD wZLow16;			//Z轴编码器低16位
	WORD wZHigh16;		//Z轴编码器高16位
	WORD wW1Low16;		//W1轴编码器低16位
	WORD wW1High16;		//W1轴编码器高16位
	WORD wALow16;			//A轴编码器低16位
	WORD wAHigh16;		//A轴编码器高16位
	WORD wBLow16;			//B轴编码器低16位
	WORD wBHigh16;		//B轴编码器高16位
	WORD wW2Low16;		//W2轴编码器低16位
	WORD wW2High16;		//W2轴编码器高16位
