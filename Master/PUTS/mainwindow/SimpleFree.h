...
*
* OPC
* Filename: SimpleFree.h
*
* @author        Wang Qianfeng
* @version       1.00         Date: 2013-06-25
*/

#ifndef _CSIMPLEFREE_H_
#define _CSIMPLEFREE_H_
...
const WORD ITEM_NUM = 75;
const WORD ITEM_GENERAL_NUM = 15;	
const WORD ITEM_NEI1_RESULT_NUM = 24;
const WORD ITEM_NEI2_RESULT_NUM = 24;
const WORD ITEM_NEI3_RESULT_NUM = 12;
const WORD ITEM_NEI4_RESULT_NUM = 12;
const WORD ITEM_BIAN_RESULT_NUM = 2;
const WORD ITEM_NEIBOX_STATUS_NUM = 6;	
const WORD ITEM_NEIBOX_STATUS_NUM2 = 2;	
