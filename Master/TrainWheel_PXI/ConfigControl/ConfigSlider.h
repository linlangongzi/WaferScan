#ifndef CONFIGSLIDER_H
#define CONFIGSLIDER_H

#include "ConfigControlInterface.h"
#include <QSlider>

class ConfigSlider : public QSlider, public ConfigControlInterface
{
    Q_OBJECT
public:
    explicit ConfigSlider(QWidget *parent = 0);
