#ifndef CONFIGCOMBOX_H
#define CONFIGCOMBOX_H
...
class ConfigCombox : public QComboBox, public ConfigControlInterface
{
    Q_OBJECT
public:
    explicit ConfigCombox(QWidget *parent = 0);
