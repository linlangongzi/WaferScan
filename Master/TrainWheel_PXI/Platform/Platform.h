...
public:
    ...
    int GetDeleteFrameNum();
    int GetCommunicationId();
    int GetSensorCardNum();
    int GetStraightFlangeCardNum();
    int Get21DegreeCardNum();
    bool IsStraightFlangeTwoSensor();
    bool Is21DegreeTwoSensor();
private:
    virtual void Init();
...
signals:
    void VersionRead(sharedVersionLower version);
