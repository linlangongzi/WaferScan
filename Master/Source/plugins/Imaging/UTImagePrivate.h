...
public:
    ...
    Image8 Render8(CDataValue min, CDataValue max, const UTImagePrivate *mask = nullptr);
    ...
    Image8 ToMask() const;
    DataType SubImage(const QRect &ROI, const UTImagePrivate *mask = nullptr) const;
    Image8 SubImage8(CDataValue alpha, CDataValue beta, const QRect &ROI, const UTImagePrivate *mask = nullptr) const;
