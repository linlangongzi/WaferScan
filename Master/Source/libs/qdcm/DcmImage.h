...
private:
    ...
    DcmDataset *m_dataset = nullptr;   ///< DICOM dataset associated with this image.
    DcmTagPixelData *m_tagPixelDataPtr = nullptr; ///< Pointer to pixel data tag within the image dataset (for easy access).
};
